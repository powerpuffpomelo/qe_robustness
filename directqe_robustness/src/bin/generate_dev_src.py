...
from src.main import generate_dev_src
...
parser.add_argument('--lm', type=str, help='MLM or LM_forward or LM_backward')
...
parser.add_argument("--split", type=str, default="dev",
                    help="""which part to generate, train/dev/test""")
...
parser.add_argument("--align_bpe_path", type=str, default=None,
                    help="""align_bpe_path""")
