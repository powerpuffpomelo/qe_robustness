...
from src.main import new_finetune
...
parser.add_argument('--log_path_prefix', type=str, default="./log",
...
parser.add_argument("--wo", type=str,
                    help="""without negetive 10%, or positive 10% """)
...
def run(**kwargs):
    ...
    auto_mkdir(args.log_path_prefix)
