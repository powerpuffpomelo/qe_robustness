...
from src.main import finetune_qe_align_attn_v3
...
parser.add_argument("--align_bpe_path_mt2src_train", type=str, default="",
                    help="""Path to align bpe file""")

parser.add_argument("--align_bpe_path_mt2src_dev", type=str, default="",
                    help="""Path to align bpe file""")

parser.add_argument('--attn_align_lambda', type=float, default="0.5")
...
def run(**kwargs):
    ...
    finetune_qe_align_attn_v3(args)
