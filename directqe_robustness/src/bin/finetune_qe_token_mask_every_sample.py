...
from src.main import finetune_qe_token_mask_every_sample
...
parser.add_argument('--sample_seg_path', type=str, default="./",
                    help="begin end position of every sample")
...
def run(**kwargs):
    ...
    finetune_qe_token_mask_every_sample(args)
