...
from src.main import train_discriminator_no_need_2_generate_cl
...
parser.add_argument("--cl_aug", type=int, default=10,
                    help="""Enhance the impact of cl_loss""")
...
def run(**kwargs):
    ...
    train_discriminator_no_need_2_generate_cl(args)
