...
python3 -m src.bin.train_discriminator_no_need_2_generate \
    ...
    --config_path "./configs/train_directqe_ende/pretrain_discriminator_ende_asyn.yaml" \
...
# bash /home/data_ti4_c/yanym/code/directqe_analysis/scripts/train_directqe_ende/train_discriminator_ende_asyn.sh