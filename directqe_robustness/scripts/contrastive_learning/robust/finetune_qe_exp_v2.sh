...
python -m src.bin.finetune_qe_align_attn_v2 \
    ...
    --attn_align_lambda 0.02 \
    --log_path "/data1/yanym/save/directqe_enzh_bpe_robust/discriminator_finetuned_256_align_attn_v2_lambda_0.02" \
    --saveto "/data1/yanym/save/directqe_enzh_bpe_robust/discriminator_finetuned_256_align_attn_v2_lambda_0.02" \
    --use_gpu


# bash scripts/contrastive_learning/robust/finetune_qe_align_attn_v2.sh 1234