...
python -m src.bin.finetune_qe_align_attn_v2 \
    ...
    --log_path "/data1/yanym/save/directqe_enzh_bpe_robust/discriminator_finetuned_256_align_attn_v2_lambda_0.5" \
    --saveto "/data1/yanym/save/directqe_enzh_bpe_robust/discriminator_finetuned_256_align_attn_v2_lambda_0.5" \
    --use_gpu
