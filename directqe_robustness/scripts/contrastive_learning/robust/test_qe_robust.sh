...
python -m src.bin.test_qe_robust \
    ...
    --saveto_tags "/data1/yanym/save/directqe_enzh_bpe_robust/imp_2finetune/discriminator_finetuned_256_imp_v1_b_mask2_plus_word2vec_double/test_result/robust_test.tag_idxonly.BPE" \
    --batch_size 20 \
    --use_gpu
