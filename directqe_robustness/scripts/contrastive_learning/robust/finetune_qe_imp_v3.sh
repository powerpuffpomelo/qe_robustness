...
python -m src.bin.finetune_qe_robust_aug_dynamic \
    ...
    --log_path "/data1/yanym/save/directqe_enzh_bpe_robust/discriminator_finetuned_256_robust_aug_v3" \
    --saveto "/data1/yanym/save/directqe_enzh_bpe_robust/discriminator_finetuned_256_robust_aug_v3" \
    --align_bpe_path_mt2src "/data1/yanym/data/test_align/train.mt-src.alignments.BPE" \
    --use_gpu


# bash scripts/contrastive_learning/robust/finetune_qe_robust_aug_dynamic.sh 1234