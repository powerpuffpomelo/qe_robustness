...
python3 -m src.bin.train_discriminator_one_class \
    ...
    --log_path "/data1/yanym/save/directqe_enzh_bpe_robust/one_class/discriminator_pretrained_256_one_class" \
    --saveto "/data1/yanym/save/directqe_enzh_bpe_robust/one_class/discriminator_pretrained_256_one_class/" \
    --use_gpu

# bash scripts/contrastive_learning/robust/train_discriminator_one_class.sh