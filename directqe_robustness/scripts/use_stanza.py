...
de_nlp = stanza.Pipeline('de', processors='tokenize,lemma,pos,depparse', verbose=False, tokenize_pretokenized=True)
path_prefix = '/home/user_data_182b/yanym/qe/data/wmt19_ende/qe_data/'

for split in ['train', 'dev', 'test']:
    with open(path_prefix+split+'.mt', 'r', encoding='utf-8') as f, open(path_prefix+split+'.pos', 'w', encoding='utf-8') as fpos:
