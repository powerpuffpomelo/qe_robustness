...
python3 -m src.bin.train_discriminator \
    ...
    --config_path "./configs/train_directqe_enzh/pretrain_discriminator_enzh_occ.yaml" \
    --log_path "/data1/yanym/save/directqe_enzh/discriminator_pretrained_256_occ" \
    --saveto "/data1/yanym/save/directqe_enzh/discriminator_pretrained_256_occ/" \
    --use_gpu

# bash scripts/train_directqe_enzh/train_discriminator_occupy.sh