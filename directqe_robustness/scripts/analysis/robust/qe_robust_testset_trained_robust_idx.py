# 被训练过鲁棒性的token集合文件，标注qe鲁棒性测试集每个token是否被训练过鲁棒性，标注01，得到一个和qe鲁棒性测试集mt bpe文件对应的idx文件；
# 注意，仅仅考虑被测试鲁棒性的token，所以鲁棒性idx也要考虑，不过这不是本脚本要考虑的问题了。

qe_test_mt_path = "/data1/yanym/data/robust_qe_test/generate_dev/robust_test.mt.BPE"
robust_token_path = "/data1/yanym/data/robust_qe_train_v1/robust_train.robust_token_set"
qe_test_robust_trained_idx_path = "/data1/yanym/data/robust_qe_test_analysis/robust_test_robust_trained_idx.BPE"
...
# python scripts/analysis/robust/qe_robust_testset_trained_robust_idx.py