...
def main(filename, save, num, freq, char, verbose):
    ...
    #os.makedirs("/home/yanym/data/wmt20/enzh/task2/mello_version/", exist_ok=True)
...
if __name__ == '__main__':
    ...
    main(filename=args.file, save=args.save, num=args.num, freq=args.freq, char=args.char, verbose=args.verbose)


# python /home/data_ti4_c/yanym/code/directqe_analysis/scripts/build_dictionary.py --file /home/yanym/save/data/train.enzh.zh.plus_qe_mt --save /home/yanym/save/data/vocab_2kw_7k_100.zh --num 30000