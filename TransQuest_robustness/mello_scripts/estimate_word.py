...
PRE_PREFIX=/home/yanym/save/transquest/data
python mello_scripts/estimate_word.py $GOLD_PREFIX/test.src_tag $PRE_PREFIX/predictions_src.txt
...
PRE_PREFIX=/data1/yanym/data/robust_qe_test/pred_transquest
python mello_scripts/estimate_word.py $GOLD_PREFIX/robust_test.tag_idxonly $PRE_PREFIX/robust_test.mt_tag_robust.pred
"""