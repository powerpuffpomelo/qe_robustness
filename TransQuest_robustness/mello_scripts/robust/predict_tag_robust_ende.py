...
TEST_PATH = "/data1/yanym/data/robust_qe_test_ende/generate_dev/"
TEST_SOURCE_FILE = "robust_test.src"
TEST_TARGET_FILE = "robust_test.mt"
TEST_MT_ROBUST_ID_FILE = "robust_test.idx"
TEMP_DIRECTORY = "/data1/yanym/data/robust_qe_test_ende/pred_transquest"
...
python -m mello_scripts.predict_tag_robust_ende
"""